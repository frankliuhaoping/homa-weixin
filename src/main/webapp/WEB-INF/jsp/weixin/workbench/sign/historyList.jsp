...
<body>
<div class="page " id="sign-historyList">
	<div class="content">
		<div class="aoma_top">
		    <span style="float:left;margin-left:15px;" class="date_reduce"><i class="iconfont_m">&#xe652;</i></span>
		    <span class="date_year">2015</span>-<span class="date_month">4</span>
		    <span style="float:right;margin-right:15px;" class="date_plus"><i class="iconfont_m">&#xe64f;</i></span>
		</div>
...
<script type='text/javascript' src='${contextPath}/static/wxworkbench/js/sign/historyList.js' charset='utf-8'></script>	
</body>
</html>
