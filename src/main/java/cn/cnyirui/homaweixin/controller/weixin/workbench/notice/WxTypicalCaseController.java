...
@Controller
@RequestMapping("/weixin/workbench/typicalCase")
public class WxTypicalCaseController extends BaseCRUDController<TypicalCase> {
	...
	public String noticeDetail(Model model, String id) {
		String employeeName = CurrentUserUtils.getEmployee(true).getName();
