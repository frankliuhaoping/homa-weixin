...
@Controller
@RequestMapping("/backend/countSalesOrderByProduct")
public class CountSalesOrderByProductController extends BaseCRUDController<SalesOrder> {
	...
	public ObjectNode doJsonList(Searchable searchable, HttpServletRequest request) {
		return salesOrderService.countSalesOrderByProduct(searchable, request);
	}
