 ...
 *     查询参数格式如下：
 *     1.1、默认查询字符串
 *         search.baseInfo.realname_like=kk
 *         search.age_lt=12
 ...
 *
 *     2.1、自定义查询字符串
 *         foo_search.baseInfo.realname_like=kk
...
public class SearchableMethodArgumentResolver extends BaseMethodArgumentResolver {
	 ...
	 * 分页参数解析器
	 */
	private PageableMethodArgumentResolver pageableResolver;

	public void setPageableMethodArgumentResolver(
			PageableMethodArgumentResolver pageableMethodArgumentResolver) {
		this.pageableResolver = pageableMethodArgumentResolver;
	}

	public PageableMethodArgumentResolver getPageableMethodArgumentResolver() {
		if (pageableResolver == null) {
			pageableResolver = new PageableMethodArgumentResolver();
		}
	...
	public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
		...
		Pageable pageable = (Pageable) getPageableMethodArgumentResolver().resolveArgument(parameter, mavContainer,
