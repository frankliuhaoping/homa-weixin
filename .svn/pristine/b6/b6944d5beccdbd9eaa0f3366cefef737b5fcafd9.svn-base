...
<body>
    ...
    <div id='datagrid-toolbar' class="datagrid-toolbar">
        ...
        <div class="searchForm">
			<form id="searchForm" class="easyui-form">
				<label>组织架构 </label><input class="easyui-textbox" name="search.organization.name_like">
				<label>姓名 </label><input class="easyui-textbox" name="search.employee.name_like">
				<label>年份 </label><input class="easyui-textbox" name="search.year_eq">
	...
	<script src="${contextPath}/static/js/backend/salesTask.js"></script>
</body>
</html>