...
import cn.cnyirui.framework.dao.search.exception.InvlidSearchOperatorException;
...
public final class Condition implements SearchFilter {
	...
	static Condition newCondition(final String key, final Object value) throws SearchException {
		...
		if (searchs.length == 0) {
			throw new SearchException("Condition key format must be : property or property" + separator + "op");
		}
