...
@Controller
@RequestMapping("/backend/countSalesOrderByProductCategory")
public class CountSalesOrderByProductCategoryController extends BaseCRUDController<SalesOrder> {
	...
	public ObjectNode doJsonList(Searchable searchable, HttpServletRequest request) {
		return salesOrderService.countSalesOrderByProductCategory(searchable, request);
	}
